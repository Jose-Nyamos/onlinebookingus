...
import Cabin from '../../assets/wp-content/uploads/2018/08/4-1-1-1-scaled-1-400x314.jpg';
import Sunny from '../../assets/wp-content/uploads/2018/08/9-1-1-1-400x314.jpg';
import Bed from '../../assets/wp-content/uploads/2018/08/3-1-1-400x314.jpg';
        ...
        <div class="property_categs ">
         <div class="category_wrapper ">
          <h1 itemprop="name" class="entry-title ">
           ...
           nice 1Br apt in nj near manhattan 111050403{' '}
          </h1>
         ...
         <div id="listing_description_type3">
          ...
          <div itemprop="description" id="listing_description_content" class="panel-body">
           <p>
            Very very nice apartment with nice view ,<br />
            Fully furnished , all lenin -towels-
            <br />
            Kitchen utensils – TV with internet – AC microwave – dishwasher – washer/dryer
            <br />
            Queen size bed – dining table – nice open view – etc
            <br />
            Location super : park nearby 4 min walk
            <br />
            Restaurants next building: Tasty Falafels – Sushi – lobster – pizza – bakery
            <br />
            Salon and beauty center
            <br />
            Bus cross street- taxi and all transportation
            <br />
            Mall nearby 7 min by car etc
           </p>
          </div>{' '}
         </div>
        </div>
