                            ...
                            <div class="card-body">
                             ...
                             <form>
                              <div class="row p-4">
                                      ...
                                      <label for="charge_name"><b>PayPal Username</b></label>
                                       </div>
                                        ...
                                        <div className="col-md-1"></div>
                                      <div className="col-md-4">
                                      <label for="charge_name"><b>PayPal Password</b></label>
                                       </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <input class="form-control form-control-rounded" name="title" type=" number"   />
                                        </div>
                                        ...
                                        <div className="col-md-1"></div>
                                      <div className="col-md-4">
                                      <label for="charge_name"><b>PayPal Signature </b></label>
                                       </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <input class="form-control form-control-rounded" name="title" type=" number"   />
                                        </div>
                                        ...
                                        <div className="col-md-1"></div>
                                      <div className="col-md-4">
                                      <label for="charge_name"><b>PayPal Mode</b></label>
                                       </div>
                                        <div class="col-md-6 form-group mb-3">
                                        ...
                                        <div className="col-md-1"></div>
                                      <div className="col-md-4">
                                      <label for="charge_name"><b>Paypal Status</b></label>
                                       </div>
                                        <div class="col-md-6 form-group mb-3">
                                        <select class="form-control form-control-rounded">
