...
const Addbooking = () => {
 ...
 const [isLoading,setLoading]=useState(false);
  ...
  const handleUserChange= async (event) => {
    ...
    //   var my_user_object = userObject;

    //   setfirst_name(my_user_object.first_name==null? '':my_user_object.first_name)

    //   setEmail(my_user_object.email==null? '':my_user_object.email)

    //   setPhone_no(my_user_object.phone_no==null? '':my_user_object.phone_no)
   ...
   const handlePropertyChange=async (event) => {
    ...
    const add_customer = () => {
      ...
      const saveBookingDetails = () => {
        ...
        setLoading(true);
        Axios.post("https://onlinebookingus-app-test.herokuapp.com/booking", {
          host_id: host_id,
          user_id: user_id,
          UserId: user_id,
                          ...
                          <div class="col-md-3 col-sm-4 col-xs-12">
                                ...
                                class="form-control select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                      ...
                                      {usersList.map((value, key) => {
                                        return (
                                      <option value={value.id}>{value.first_name===null ? '' : value.first_name} {value.id}</option>
