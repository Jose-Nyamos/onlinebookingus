...
export default function ProfileInfo() {
    ...
    console.log("THE USER ID IS"+authState.id)

    let user_id=authState.id
   ...
   // console.log("THIS IS YOUR USER ID"+user_id)
    ...
    const updateProfile=()=>{
        ...
        history.push('/update-profile/'+user_id)       
    }
        ...
        <div class="main-content">
            <div class="breadcrumb">
                ...
                <ul>
                    ...
                    <li>Role {authState.id}</li>
                </ul>
                <ul style={{float:"right"}}>
                <li><button onClick={updateProfile} class="btn btn-warning">Update Profile</button></li>
            ...
            <div class="card user-profile o-hidden mb-4">
                ...
                <div class="user-info"><img class="profile-picture avatar-lg mb-2" src="../../dist-assets/images/faces/1.jpg" alt="" />
                    <p class="m-0 text-24">{authState.first_name}</p>
                    <p class="text-muted m-0">{authState.role}</p>
                </div>
                <div class="card-body">
