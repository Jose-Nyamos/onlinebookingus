...
export default function FeaturedInfo() {
    ...
    useEffect(()=>{
        ...
        Axios.get("https://onlinebookingus-app-test.herokuapp.com/property/allproperties").then((response) => {
          ...
          Axios.get("https://onlinebookingus-app-test.herokuapp.com/users/allusers").then((response) => {
            setusersList(response.data);
          });


          Axios.get("https://onlinebookingus-app-test.herokuapp.com/booking/bookings").then((response) => {
            ...
            <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="card card-icon mb-4">
                                    <div class="card-body text-center"> <a href='/manage-properties'><i class="i-Home1"></i></a>
                                  
                                      <a href='/manage-properties'><p class="text-muted mt-2 mb-2">Total&apos;s Properties</p></a>  
                                      <a href='/manage-properties'>  <p class="text-primary text-24 line-height-1 m-0">{propertyList.length}</p></a>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="card card-icon mb-4">
                                    <div class="card-body text-center"><a href='/users'><i class="i-Add-User"></i></a>
                                    <a href='/users'> <p class="text-muted mt-2 mb-2">Total Users</p></a>  
                                    <a href='/users'> <p class="text-primary text-24 line-height-1 m-0">{usersList.length}</p></a>  
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="card card-icon mb-4">
                                    <div class="card-body text-center"><a href='/bookings'><i class="i-Shop"></i></a>
                                    <a href='/bookings'>  <p class="text-muted mt-2 mb-2">Total Reservations</p> </a>
                                    <a href='/bookings'>  <p class="text-primary text-24 line-height-1 m-0">{bookingList.length}</p></a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card o-hidden mb-4">
                            <div class="card-header d-flex align-items-center">
                                <h3 class="w-50 float-left card-title m-0">Properties</h3>
                                <div class="dropdown dropleft text-right w-50 float-right">
                            ...
                            <div class="card-body">
                                <div class="ul-widget__head">
                                    <div class="ul-widget__head-label">
                                        <h3 class="ul-widget__head-title">Latest Listing</h3>
                                    </div>
                                            ...
                                            {propertyList.map((value, key) => {
                                                ...
                                                <div class="ul-widget5__item">
                                                    <div class="ul-widget5__content">
                                                        <div class="ul-widget5__pic"><img src="../../dist-assets/images/products/a-01.png" alt="Third slide" /></div>
                                                        <div class="ul-widget5__section"><a class="ul-widget4__title" href="#">{value.name}</a>
                                                            <p class="ul-widget5__desc">{value.property_type}</p>
                                                            <div class="ul-widget5__info"><span>Owner:</span><span class="text-primary">{value.User.first_name}</span><span>Added On:</span><span class="text-primary">{value.createdAt}</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="ul-widget5__content">
                    ...
                    <div class="col-lg-6 col-xl-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="ul-widget__head">
                                    <div class="ul-widget__head-label">
                                        <h3 class="ul-widget__head-title">Checkin/Checkout Log</h3>
                                    </div>
                                    <div class="ul-widget__head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold ul-widget-nav-tabs-line" role="tablist">
